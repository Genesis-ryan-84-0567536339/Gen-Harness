...
Giai đoạn 1: kiểm chuỗi Action Log hằng đêm, bảo trì phân vùng pg_partman. Các giai đoạn sau thêm
ingest, refinery, nén sổ tay… dưới dạng plugin hoặc cron ở đây.
"""
...
class WorkerSettings:
    ...
    functions = [verify_action_log, partition_maintenance]
